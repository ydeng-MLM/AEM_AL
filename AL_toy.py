        ...
        for data_type in data_types:
            for query_type in query_types:
                for n_batch in [10]:
                    ...
                    np.savetxt('benchmark_summary/toy_opt/101722'+data_type+'_mse_array_n_init_'+str(n_init)+'_pool_ratio_'+str(pool_ratio)+'_'+query_type+str(i)+'.csv', mse_array, delimiter=',')
