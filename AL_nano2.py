            ...
            for query_type in query_types:
                for n_init in [1500]:
                    for pool_ratio in [5]:
                        ...
                        np.savetxt('benchmark_summary/Nano2_opt/062122/'+data_type+'_mse_array_n_init_'+str(n_init)+'_pool_ratio_'+str(pool_ratio)+'_'+query_type+str(i)+'.csv', mse_array, delimiter=',')
